...
public class OrdemServicoController {
	...
	public ModelAndView osSalvo(@Valid OrdemServico ordemServico, BindingResult  bindingResult, RedirectAttributes redirectAttributes) {
		...
		redirectAttributes.addFlashAttribute("mensagem", "Ordem de Servi�o salvo com sucesso!");
		return mv;
	}
	...
	public ModelAndView excluirOS(@RequestParam long id, RedirectAttributes redirectAttributes) {
		...
		try {
			...
			redirectAttributes.addFlashAttribute("mensagem", "Ordem de Servi�o exclu�do com sucesso.");
		} catch (Exception e) {
			redirectAttributes.addFlashAttribute("mensagem", "Erro ao excluir Orde de Servi�o.");
		}
		return mv;
	}
}
