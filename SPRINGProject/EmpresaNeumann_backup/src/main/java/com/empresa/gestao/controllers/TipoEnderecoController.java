...
public class TipoEnderecoController {
	...
	public ModelAndView tipoEnderecoSalvo(@Valid TipoEndereco tpend, BindingResult  bindingResult, RedirectAttributes redirectAttributes) {
		...
		redirectAttributes.addFlashAttribute("mensagem", "Tipo de Endere�o salvo com sucesso!");
		return mv;
	}
	...
	public ModelAndView excluirTipoEndereco(@RequestParam long id, RedirectAttributes redirectAttributes) {
		...
		try {
			...
			redirectAttributes.addFlashAttribute("mensagem", "Tipo de Endere�o exclu�do com sucesso.");
		} catch (Exception e) {
			redirectAttributes.addFlashAttribute("mensagem", "Erro ao excluir Tipo de Endere�o.");
		}
		return mv;
	}
}
